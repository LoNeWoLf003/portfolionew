          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">
                sayaksengupta2110@gmail.com
              </span>
              <a
                href="mailto:sayaksengupta2110@gmail.com"
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">+91-82405-42475</span>
              <a href="https://wa.me/8240542475" className="contact__button">
                Write to me{" "}
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
              </a>
            </div>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">Sayak SenGupta</span>
              <a
